...
const WatchingShows = () => {
 const {data:movies, isLoading}= useGetSavedMovies({category: "watching"})
...
const slideRight = () => {
 ...
 const response = await deleteMovie({
    videoId: movieId,
    category: "watching", // or "watchLater", "watching"
  })
 ...
 {movies && movies.length > 0 && <div className="mt-4 md:mt-6">
    <h2 className="text-white font-bold md:text-xl mb-3">Watching</h2>
